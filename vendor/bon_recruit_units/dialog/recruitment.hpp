...
class RecruitUnitsDialog {
	...
	onLoad = "[] execVM 'vendor\bon_recruit_units\build_unitlist.sqf'";
	...
	class controlsBackground {
		class Mainbackgrnd : BON_RscPicture {
			...
			x = 0.1; y = 0.101;
			w = 0.55; h = 0.8;
			//text = "vendor\bon_recruit_units\dialog\ui_background_controlers_ca.paa";
	...
	class controls {
		...
		class Unitlist: BON_RscListBox {
			...
			onLBSelChanged = "";
			onLBDblClick = "execVM 'vendor\bon_recruit_units\recruit.sqf'";
			rowHeight = 0.025;
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Recruit";
			onButtonClick = "execVM 'vendor\bon_recruit_units\recruit.sqf'";
		};
